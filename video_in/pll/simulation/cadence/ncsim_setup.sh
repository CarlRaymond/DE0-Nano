...
# ACDS 18.1 625 win32 2018.10.29.21:36:09
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pll_video_pll_0.v"                           -work video_pll_0       -cdslib ./cds_libs/video_pll_0.cds.lib      
